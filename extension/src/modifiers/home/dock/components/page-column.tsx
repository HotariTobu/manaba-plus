...
export const PageColumn = (props: {
  ...
  <SortableZone className={cn(props.sortable && classNames[props.position])} containerId={props.position} items={props.items} disabled={!props.sortable} growOnlyHeight={props.sortable}>
